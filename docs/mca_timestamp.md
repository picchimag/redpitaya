...
| bits | field | notes |
|---|---|---|
| `[47:0]`  | timestamp | microseconds since `clear_ts`; 48-bit ⇒ 8.9-yr wrap |
| `[62:48]` | energy | 15-bit peak height |
| `[63]`    | chb | channel-B input, 1 if `chB ≥ chb_threshold` |
