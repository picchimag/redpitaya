...
# module references:
# integrator, pid_simple_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins pid/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins pid/s_axi_aresetn]
