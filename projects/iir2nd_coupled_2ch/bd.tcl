...
# module references:
# integrator, iir2nd_coupled_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, iir2nd_coupled_axi_wrap
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins iir2nd1/x_in]
  ...
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd1/iir2nd_coupled_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -with_name SEG_iir2nd_coupled_axi_w_0_reg0 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/iir2nd_coupled_0/s_axi/reg0] -force
