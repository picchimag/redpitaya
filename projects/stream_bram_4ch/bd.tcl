...
# module references:
# axis_red_pitaya_dac, axis_red_pitaya_adc, stream4channel_axi_wrap, bram_interface
...
proc create_hier_cell_data_stream { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins stream4channel_axi_w_0/s_axi]

  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins stream4channel_axi_w_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net Net2 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins stream4channel_axi_w_0/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn]
...
\
  ...
  connect_bd_intf_net -intf_net ps_0_M_AXI_GP0 [get_bd_intf_pins ps_0/M_AXI_GP0] [get_bd_intf_pins smartconnect_0/S00_AXI]
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins data_stream/in1] [get_bd_pins dac/In0] [get_bd_pins data_stream/in3]
  ...
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins data_stream/in0] [get_bd_pins dac/In1] [get_bd_pins data_stream/in2]
