...
# module references:
# axis_red_pitaya_dac, axis_red_pitaya_adc
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net In0_1 [get_bd_pins adc/Dout0] [get_bd_pins dac/In0]
  ...
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk]
