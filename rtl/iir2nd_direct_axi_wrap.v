...
module iir2nd_direct_axi_wrap #(
    ...
    // ---------------------------------------------------------
    // Example (direct-form):
    wire signed [31:0] b0_s32   = regs[0];  // +0x00
    wire signed [31:0] b1_s32   = regs[1];  // +0x04
    wire signed [31:0] b2_s32   = regs[2];  // +0x08
    wire signed [31:0] a1_s32   = regs[3];  // +0x0C
    wire signed [31:0] a2_s32   = regs[4];  // +0x10
    wire signed [31:0] gain_s32 = regs[5];  // +0x14 (lower GAIN bits used)
    ...
    iir2nd_direct #(
        ...
        .x_in         (x_in),                 // 32-bit
        .slow_clk     (slow_clk),
        .b0           (b0_s32[31:0]),        // module uses only COEFF_WIDTH LSBs
        .b1           (b1_s32[31:0]),
        .b2           (b2_s32[31:0]),
        .a1           (a1_s32[31:0]),
        .a2           (a2_s32[31:0]),
        .gain_in      (gain_s32[17:0]),      // lower 18 bits
