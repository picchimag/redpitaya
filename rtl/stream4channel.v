`timescale 1 ns / 1 ps
// stream4channel.v  (hold-until-ack; decimated 4ch snapshot into BRAM)

module stream4channel #(
  parameter integer SAMPLE_WIDTH = 16,
  parameter integer N_CH         = 4,
  parameter integer PACK_WIDTH   = SAMPLE_WIDTH * N_CH,  // 64
  ...
  // ---- pack one 64-bit sample ----
  wire [PACK_WIDTH-1:0] pack_data = {in3, in2, in1, in0};
