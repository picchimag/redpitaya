...
# module references:
# integrator, iir2nd_direct_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, iir2nd_direct_axi_wrap
...
proc create_hier_cell_iir2nd1 { parentCell nameHier } {
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins integrator_0/clk] [get_bd_pins iir2nd_direct_axi_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins iir2nd_direct_axi_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net iir2nd1_y_out [get_bd_pins iir2nd1/y_out] [get_bd_pins dac/In1]
  connect_bd_net -net iir2nd_y_out [get_bd_pins iir2nd/y_out] [get_bd_pins dac/In0]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins iir2nd/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins iir2nd1/s_axi_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins iir2nd/s_axi_aresetn] [get_bd_pins iir2nd1/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins iir2nd/x_in]
  connect_bd_net -net x_in_2 [get_bd_pins adc/Dout1] [get_bd_pins iir2nd1/x_in]

  # Create address segments
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd1/iir2nd_direct_axi_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -with_name SEG_iir2nd_direct_axi_wr_0_reg0 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/iir2nd_direct_axi_0/s_axi/reg0] -force
