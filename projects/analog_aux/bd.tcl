...
# module references:
# xadc_4ch, axis_red_pitaya_dac, axis_red_pitaya_adc
...
proc create_hier_cell_dac { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 13 -to 0 In1
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_IS_DUAL {0} $axi_gpio_0
  ...
  # Create instance: xadc_4ch_0, and set properties
  set block_name xadc_4ch
  set block_cell_name xadc_4ch_0
  if { [catch {set xadc_4ch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xadc_4ch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net Vaux8_1 [get_bd_intf_ports Vaux8] [get_bd_intf_pins xadc_4ch_0/Vaux8]
  ...
  connect_bd_net -net aux_adc0_0_dbg_sample_count [get_bd_pins xlconcat_2/dout] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins xadc_4ch_0/clk]
  ...
  connect_bd_net -net soc_peripheral_aresetn [get_bd_pins soc/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net xadc_4ch_0_dbg_channel [get_bd_pins xadc_4ch_0/dbg_channel] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net xadc_4ch_0_dbg_drdy [get_bd_pins xadc_4ch_0/dbg_drdy] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net xadc_4ch_0_dbg_raw [get_bd_pins xadc_4ch_0/dbg_raw] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net xadc_4ch_0_dbg_sequence_cycles [get_bd_pins xadc_4ch_0/dbg_cycles_per_sample] [get_bd_pins xlconcat_2/In3]
  connect_bd_net -net xadc_4ch_0_out_vaux8 [get_bd_pins xadc_4ch_0/out_aux_8] [get_bd_pins dac/In0]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins xadc_4ch_0/rst]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
