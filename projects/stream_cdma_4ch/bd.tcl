...
# module references:
# axis_red_pitaya_dac, axis_red_pitaya_adc, bram_interface, stream4channel_axi_wrap
...
\
  ...
  connect_bd_intf_net -intf_net S_AXI_HP0_1 [get_bd_intf_pins S_AXI_HP0] [get_bd_intf_pins ps_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net ps_0_M_AXI_GP0 [get_bd_intf_pins smartconnect_0/S00_AXI] [get_bd_intf_pins ps_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins M00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]

  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_1 [get_bd_pins AXI_ACLK] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net rst_0_interconnect_aresetn [get_bd_pins rst_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net data_stream_0_M00_AXI [get_bd_intf_pins data_stream/M00_AXI] [get_bd_intf_pins soc/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net soc_M00_AXI [get_bd_intf_pins soc/M00_AXI] [get_bd_intf_pins data_stream/S_AXI]

  # Create port connections
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins dac/In0] [get_bd_pins data_stream/in1] [get_bd_pins data_stream/in3]
  ...
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/AXI_ACLK] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins data_stream/s_axi_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins data_stream/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins dac/In1] [get_bd_pins data_stream/in0] [get_bd_pins data_stream/in2]

  # Create address segments
  assign_bd_address -offset 0x41000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x41000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces data_stream/axi_cdma_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  exclude_bd_addr_seg -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs soc/ps_0/S_AXI_HP0/HP0_DDR_LOWOCM]
