...
# module references:
# integrator, iir2nd_direct, axis_red_pitaya_dac, axis_red_pitaya_adc
...
proc create_hier_cell_iir2nd { parentCell nameHier } {
  ...
  set_property CONFIG.C_IS_DUAL {1} $axi_gpio_1


  # Create instance: axi_gpio_2, and set properties
  set axi_gpio_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_2 ]
  set_property CONFIG.C_IS_DUAL {1} $axi_gpio_2
  ...
  # Create instance: iir2nd_direct_0, and set properties
  set block_name iir2nd_direct
  set block_cell_name iir2nd_direct_0
  if { [catch {set iir2nd_direct_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $iir2nd_direct_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins S_AXI2] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net S_AXI3_1 [get_bd_intf_pins S_AXI3] [get_bd_intf_pins axi_gpio_3/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_gpio_1/S_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins iir2nd_direct_0/b1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins iir2nd_direct_0/b0]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins iir2nd_direct_0/a1]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins iir2nd_direct_0/b2]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins axi_gpio_3/gpio_io_i] [get_bd_pins iir2nd_direct_0/a2]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_pins axi_gpio_3/gpio2_io_o] [get_bd_pins axi_gpio_3/gpio2_io_i] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net iir2nd_direct_0_y_out_reg [get_bd_pins iir2nd_direct_0/y_out_reg] [get_bd_pins y_out]
  connect_bd_net -net integrator_0_counter_clk [get_bd_pins integrator_0/counter_clk] [get_bd_pins iir2nd_direct_0/slow_clk]
  connect_bd_net -net integrator_0_x_out [get_bd_pins integrator_0/x_out] [get_bd_pins iir2nd_direct_0/x_in]
  connect_bd_net -net rst_1 [get_bd_pins rst] [get_bd_pins integrator_0/rst] [get_bd_pins iir2nd_direct_0/rst]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins integrator_0/clk] [get_bd_pins iir2nd_direct_0/clk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins x_in] [get_bd_pins integrator_0/x_in]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins iir2nd_direct_0/gain_in]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins iir2nd_direct_0/filter_reset]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net soc_M00_AXI [get_bd_intf_pins soc/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net soc_M01_AXI [get_bd_intf_pins soc/M01_AXI] [get_bd_intf_pins iir2nd/S_AXI1]
  connect_bd_intf_net -intf_net soc_M02_AXI [get_bd_intf_pins soc/M02_AXI] [get_bd_intf_pins iir2nd/S_AXI2]
  connect_bd_intf_net -intf_net soc_M03_AXI [get_bd_intf_pins soc/M03_AXI] [get_bd_intf_pins iir2nd/S_AXI3]

  # Create port connections
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins dac/In1]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins iir2nd/rst] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net iir2nd_y_out [get_bd_pins iir2nd/y_out] [get_bd_pins dac/In0]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins iir2nd/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins adc/aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins iir2nd/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins iir2nd/x_in]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -with_name SEG_axi_gpio_0_Reg -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x41230000 -range 0x00010000 -with_name SEG_axi_gpio_0_Reg_1 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -with_name SEG_axi_gpio_1_Reg -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -with_name SEG_axi_gpio_2_Reg -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/axi_gpio_3/S_AXI/Reg] -force
