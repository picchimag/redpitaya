...
# module references:
# integrator, iir2nd_coupled, axis_red_pitaya_dac, axis_red_pitaya_adc
...
proc create_hier_cell_iir2nd { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins iir2nd_coupled_0/beta]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins iir2nd_coupled_0/alpha]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins iir2nd_coupled_0/gainQ]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins iir2nd_coupled_0/gainP]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins axi_gpio_3/gpio_io_i]
  connect_bd_net -net axi_gpio_3_gpio2_io_o [get_bd_pins axi_gpio_3/gpio2_io_o] [get_bd_pins axi_gpio_3/gpio2_io_i] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net iir2nd_coupled_0_y_out_reg [get_bd_pins iir2nd_coupled_0/y_out_reg] [get_bd_pins y_out]
  ...
  connect_bd_net -net rst_1 [get_bd_pins rst] [get_bd_pins integrator_0/rst] [get_bd_pins iir2nd_coupled_0/rst]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins integrator_0/clk] [get_bd_pins iir2nd_coupled_0/clk]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins iir2nd_coupled_0/filter_reset]
