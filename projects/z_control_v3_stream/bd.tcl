...
# module references:
# integrator, iir2nd_coupled_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, pid_simple_axi_wrap, bram_interface, stream4channel_axi_wrap
...
proc create_hier_cell_data_stream { parentCell nameHier } {
  ...
  # Create instance: stream4channel_axi_w_0, and set properties
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins stream4channel_axi_w_0/s_axi]
  ...
  connect_bd_net -net Net1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins stream4channel_axi_w_0/s_axi_aclk]
  connect_bd_net -net Net2 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins stream4channel_axi_w_0/s_axi_aresetn]
...
proc create_hier_cell_pid { parentCell nameHier } {
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins pid_simple_axi_wrap_0/s_axi_aclk] [get_bd_pins integrator_0/clk]
...
# Hierarchical cell: iir2nd
proc create_hier_cell_iir2nd { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_iir2nd() - Empty argument(s)!"}
     return
  }
...
\
  ...
  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_1 [get_bd_pins M_AXI_GP0_ACLK] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: iir2nd
  create_hier_cell_iir2nd [current_bd_instance .] iir2nd
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins pid/S_AXI1] [get_bd_intf_pins soc/M01_AXI]
  ...
  connect_bd_intf_net -intf_net soc_M00_AXI [get_bd_intf_pins soc/M00_AXI] [get_bd_intf_pins iir2nd/S_AXI1]
  connect_bd_intf_net -intf_net soc_M02_AXI [get_bd_intf_pins soc/M02_AXI] [get_bd_intf_pins data_stream/S_AXI]

  # Create port connections
  connect_bd_net -net In1_1 [get_bd_pins pid/y_out] [get_bd_pins adder/B]
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins pid/x_in] [get_bd_pins data_stream/in1]
  ...
  connect_bd_net -net c_addsub_0_S [get_bd_pins adder/S] [get_bd_pins data_stream/in3] [get_bd_pins dac/In1]
  ...
  connect_bd_net -net iir2nd_y_out [get_bd_pins iir2nd/y_out] [get_bd_pins data_stream/in2] [get_bd_pins adder/A] [get_bd_pins dac/In0]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins iir2nd/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins pid/s_axi_aclk] [get_bd_pins data_stream/s_axi_aclk] [get_bd_pins adder/CLK]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins iir2nd/s_axi_aresetn] [get_bd_pins pid/s_axi_aresetn] [get_bd_pins data_stream/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins iir2nd/x_in] [get_bd_pins data_stream/in0]
  ...
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd/iir2nd_coupled_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs pid/pid_simple_axi_wrap_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/stream4channel_axi_w_0/s_axi/reg0] -force
