...
# module references:
# integrator, iir2nd_coupled_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, pid_simple_axi_wrap, stream8channel_axi_wrap, bram_interface, integrator, iir2nd_coupled_axi_wrap, integrator, pid_simple_axi_wrap, xadc_1ch
...
# Hierarchical cell: sum3
proc create_hier_cell_sum3 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_sum3() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 15 -to 0 -type data C
  create_bd_pin -dir O -from 15 -to 0 -type data S

  # Create instance: adder1, and set properties
  set adder1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_addsub:12.0 adder1 ]
  ...
  connect_bd_net -net A_1 [get_bd_pins A] [get_bd_pins adder1/A]
  connect_bd_net -net B1_1 [get_bd_pins C] [get_bd_pins adder/B]
  connect_bd_net -net B_1 [get_bd_pins B] [get_bd_pins adder1/B]
  connect_bd_net -net CE_1 [get_bd_pins xlconstant_0/dout] [get_bd_pins adder1/CE] [get_bd_pins adder/CE]
  connect_bd_net -net CLK_1 [get_bd_pins CLK] [get_bd_pins adder1/CLK] [get_bd_pins adder/CLK]
  connect_bd_net -net adder1_S [get_bd_pins adder1/S] [get_bd_pins adder/A]
  connect_bd_net -net adder_S [get_bd_pins adder/S] [get_bd_pins S]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: xadc_1ch
proc create_hier_cell_xadc_1ch { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_xadc_1ch() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -type clk clk
  create_bd_pin -dir O -from 15 -to 0 out_aux_0
  ...
  # Create instance: xadc_1ch_0, and set properties
  set block_name xadc_1ch
  set block_cell_name xadc_1ch_0
  if { [catch {set xadc_1ch_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xadc_1ch_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net Vaux8_1 [get_bd_intf_pins Vaux8] [get_bd_intf_pins xadc_1ch_0/Vaux8]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins xadc_1ch_0/clk]
  connect_bd_net -net xadc_1ch_0_out_aux_0 [get_bd_pins xadc_1ch_0/out_aux_0] [get_bd_pins out_aux_0]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins xadc_1ch_0/rst]
...
# Hierarchical cell: iir2nd1
proc create_hier_cell_iir2nd1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_iir2nd1() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins iir2nd_coupled_0/s_axi_aclk] [get_bd_pins integrator_0/clk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins iir2nd_coupled_0/s_axi_aresetn] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins integrator_0/rst]
  connect_bd_net -net x_in_1 [get_bd_pins x_in] [get_bd_pins integrator_0/x_in]
...
proc create_hier_cell_data_stream { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I -from 15 -to 0 in4
  ...
  # Create instance: stream8channel_axi_w_0, and set properties
  set block_name stream8channel_axi_wrap
  set block_cell_name stream8channel_axi_w_0
  if { [catch {set stream8channel_axi_w_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $stream8channel_axi_w_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_cdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins stream8channel_axi_w_0/s_axi]
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins stream8channel_axi_w_0/s_axi_aclk]
  connect_bd_net -net Net2 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins stream8channel_axi_w_0/s_axi_aresetn]
  ...
  connect_bd_net -net in0_1 [get_bd_pins in0] [get_bd_pins stream8channel_axi_w_0/in0]
  connect_bd_net -net in1_1 [get_bd_pins in1] [get_bd_pins stream8channel_axi_w_0/in1]
  connect_bd_net -net in2_1 [get_bd_pins in2] [get_bd_pins stream8channel_axi_w_0/in2]
  connect_bd_net -net in3_1 [get_bd_pins in3] [get_bd_pins stream8channel_axi_w_0/in3]
  connect_bd_net -net in4_1 [get_bd_pins in4] [get_bd_pins stream8channel_axi_w_0/in4]
  connect_bd_net -net stream8channel_axi_w_0_bram_addr [get_bd_pins stream8channel_axi_w_0/bram_addr] [get_bd_pins bram_interface_0/addrb]
  connect_bd_net -net stream8channel_axi_w_0_bram_din [get_bd_pins stream8channel_axi_w_0/bram_din] [get_bd_pins bram_interface_0/dinb]
  connect_bd_net -net stream8channel_axi_w_0_bram_en [get_bd_pins stream8channel_axi_w_0/bram_en] [get_bd_pins bram_interface_0/enb]
  connect_bd_net -net stream8channel_axi_w_0_bram_we [get_bd_pins stream8channel_axi_w_0/bram_we] [get_bd_pins bram_interface_0/web]
...
proc create_hier_cell_dac { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net In00_1 [get_bd_pins In0] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net In0_1 [get_bd_pins In1] [get_bd_pins xlconcat_0/In1]
...
# Hierarchical cell: iir2nd0
proc create_hier_cell_iir2nd0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_iir2nd0() - Empty argument(s)!"}
     return
  }
...
\
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins M03_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins ps_0/S_AXI_HP0] [get_bd_intf_pins S_AXI_HP0]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_1 [get_bd_pins M_AXI_GP0_ACLK] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins ps_0/S_AXI_HP0_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK]
  ...
  connect_bd_net -net rst_0_interconnect_aresetn [get_bd_pins rst_0/interconnect_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN]
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins rst_0/peripheral_aresetn] [get_bd_pins peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set adc_aux_0 [ create_bd_port -dir I -type data adc_aux_0 ]
  ...
  # Create instance: iir2nd0
  create_hier_cell_iir2nd0 [current_bd_instance .] iir2nd0
  ...
  # Create instance: data_stream
  create_hier_cell_data_stream [current_bd_instance .] data_stream

  # Create instance: iir2nd1
  create_hier_cell_iir2nd1 [current_bd_instance .] iir2nd1

  # Create instance: pid1
  create_hier_cell_pid1 [current_bd_instance .] pid1

  # Create instance: xadc_1ch
  create_hier_cell_xadc_1ch [current_bd_instance .] xadc_1ch

  # Create instance: sum3
  create_hier_cell_sum3 [current_bd_instance .] sum3

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins pid0/S_AXI1] [get_bd_intf_pins soc/M01_AXI]
  connect_bd_intf_net -intf_net S_AXI1_2 [get_bd_intf_pins iir2nd1/S_AXI1] [get_bd_intf_pins soc/M03_AXI]
  connect_bd_intf_net -intf_net S_AXI1_3 [get_bd_intf_pins pid1/S_AXI1] [get_bd_intf_pins soc/M04_AXI]
  connect_bd_intf_net -intf_net Vaux8_1 [get_bd_intf_ports Vaux8] [get_bd_intf_pins xadc_1ch/Vaux8]
  connect_bd_intf_net -intf_net data_stream_M00_AXI [get_bd_intf_pins data_stream/M00_AXI] [get_bd_intf_pins soc/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net soc_M00_AXI [get_bd_intf_pins soc/M00_AXI] [get_bd_intf_pins iir2nd0/S_AXI1]
  connect_bd_intf_net -intf_net soc_M02_AXI [get_bd_intf_pins soc/M02_AXI] [get_bd_intf_pins data_stream/S_AXI]

  # Create port connections
  connect_bd_net -net A_1 [get_bd_pins iir2nd0/y_out] [get_bd_pins sum3/A]
  connect_bd_net -net B_1 [get_bd_pins iir2nd1/y_out] [get_bd_pins sum3/B]
  connect_bd_net -net C_1 [get_bd_pins pid0/y_out] [get_bd_pins sum3/C]
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins iir2nd1/x_in] [get_bd_pins data_stream/in1] [get_bd_pins pid1/x_in]
  ...
  connect_bd_net -net c_addsub_0_S [get_bd_pins sum3/S] [get_bd_pins dac/In0] [get_bd_pins data_stream/in2]
  ...
  connect_bd_net -net pid1_y_out [get_bd_pins pid1/y_out] [get_bd_pins dac/In1] [get_bd_pins data_stream/in3]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins iir2nd0/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins pid0/s_axi_aclk] [get_bd_pins data_stream/s_axi_aclk] [get_bd_pins iir2nd1/s_axi_aclk] [get_bd_pins pid1/s_axi_aclk] [get_bd_pins xadc_1ch/clk] [get_bd_pins sum3/CLK]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins iir2nd0/s_axi_aresetn] [get_bd_pins pid0/s_axi_aresetn] [get_bd_pins data_stream/s_axi_aresetn] [get_bd_pins iir2nd1/s_axi_aresetn] [get_bd_pins pid1/s_axi_aresetn]
  connect_bd_net -net x_in_2 [get_bd_pins adc/Dout0] [get_bd_pins data_stream/in0] [get_bd_pins iir2nd0/x_in]
  connect_bd_net -net xadc_1ch_out_aux_0 [get_bd_pins xadc_1ch/out_aux_0] [get_bd_pins pid0/x_in] [get_bd_pins data_stream/in4]

  # Create address segments
  assign_bd_address -offset 0x42000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x7E200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/axi_cdma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd0/iir2nd_coupled_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40002000 -range 0x00001000 -with_name SEG_iir2nd_coupled_0_reg0_1 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd1/iir2nd_coupled_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs pid0/pid_simple_axi_wrap_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40004000 -range 0x00001000 -with_name SEG_pid_simple_axi_wrap_0_reg0_1 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs pid1/pid_simple_axi_wrap_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/stream8channel_axi_w_0/s_axi/reg0] -force
  assign_bd_address -offset 0x42000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces data_stream/axi_cdma_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces data_stream/axi_cdma_0/Data] [get_bd_addr_segs soc/ps_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
