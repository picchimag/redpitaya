...
# module references:
# integrator, iir2nd_coupled_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, pid_simple_axi_wrap, integrator, pid_simple_axi_wrap, iir2nd_direct_axi_wrap, integrator, bram_interface, stream4channel_axi_wrap
...
proc create_hier_cell_data_stream { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins stream4channel_axi_w_0/s_axi] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins stream4channel_axi_w_0/s_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins stream4channel_axi_w_0/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]
  ...
  connect_bd_net -net in0_0_1 [get_bd_pins in0] [get_bd_pins stream4channel_axi_w_0/in0]
  connect_bd_net -net in1_0_1 [get_bd_pins in1] [get_bd_pins stream4channel_axi_w_0/in1]
  connect_bd_net -net in2_0_1 [get_bd_pins in2] [get_bd_pins stream4channel_axi_w_0/in2]
  connect_bd_net -net in3_0_1 [get_bd_pins in3] [get_bd_pins stream4channel_axi_w_0/in3]
...
\
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins ps_0/S_AXI_HP0] [get_bd_intf_pins S_AXI_HP0]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_1 [get_bd_pins M_AXI_GP0_ACLK] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins ps_0/S_AXI_HP0_ACLK]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins data_stream/S00_AXI] [get_bd_intf_pins soc/M04_AXI]
  ...
  connect_bd_intf_net -intf_net data_stream_M00_AXI_0 [get_bd_intf_pins data_stream/M00_AXI] [get_bd_intf_pins soc/S_AXI_HP0]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins pll_0/clk_out1] [get_bd_pins adc/aclk] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins data_stream/ACLK] [get_bd_pins iir2nd0_direct/s_axi_aclk] [get_bd_pins pid0/s_axi_aclk] [get_bd_pins iir2nd1_coupled/s_axi_aclk] [get_bd_pins pid1/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adder/CLK]
  connect_bd_net -net adc_Dout0 [get_bd_pins adc/Dout0] [get_bd_pins pid0/x_in] [get_bd_pins data_stream/in0]
  ...
  connect_bd_net -net c_addsub_0_S [get_bd_pins adder/S] [get_bd_pins dac/In0] [get_bd_pins data_stream/in2]
  ...
  connect_bd_net -net soc_peripheral_aresetn [get_bd_pins soc/peripheral_aresetn] [get_bd_pins data_stream/ARESETN] [get_bd_pins iir2nd0_direct/s_axi_aresetn] [get_bd_pins pid0/s_axi_aresetn] [get_bd_pins iir2nd1_coupled/s_axi_aresetn] [get_bd_pins pid1/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout1] [get_bd_pins pid1/x_in] [get_bd_pins iir2nd1_coupled/x_in] [get_bd_pins data_stream/in1]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd1_coupled/iir2nd_coupled_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs iir2nd0_direct/iir2nd_direct_axi_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x40004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/stream4channel_axi_w_0/s_axi/reg0] -force
