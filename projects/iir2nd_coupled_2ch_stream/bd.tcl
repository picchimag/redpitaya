...
# module references:
# integrator, iir2nd_coupled_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, iir2nd_coupled_axi_wrap, bram_interface, stream4channel_axi_wrap
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins iir2nd1/S_AXI1] [get_bd_intf_pins soc/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net In1_1 [get_bd_pins iir2nd1/y_out] [get_bd_pins dac/In1] [get_bd_pins data_stream/in3]
  connect_bd_net -net adc_Dout1 [get_bd_pins adc/Dout1] [get_bd_pins iir2nd1/x_in] [get_bd_pins data_stream/in1]
  ...
  connect_bd_net -net iir2nd_y_out [get_bd_pins iir2nd/y_out] [get_bd_pins dac/In0] [get_bd_pins data_stream/in2]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins iir2nd/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins iir2nd1/s_axi_aclk] [get_bd_pins data_stream/s_axi_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins iir2nd/s_axi_aresetn] [get_bd_pins iir2nd1/s_axi_aresetn] [get_bd_pins data_stream/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins iir2nd/x_in] [get_bd_pins data_stream/in0]

  # Create address segments
  assign_bd_address -offset 0x41000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x41000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces data_stream/axi_cdma_0/Data] [get_bd_addr_segs data_stream/axi_bram_ctrl_0/S_AXI/Mem0] -force
