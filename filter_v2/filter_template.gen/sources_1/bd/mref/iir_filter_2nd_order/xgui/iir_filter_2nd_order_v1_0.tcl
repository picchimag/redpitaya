...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INTERNAL_STATE_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.INTERNAL_STATE_WIDTH { PARAM_VALUE.INTERNAL_STATE_WIDTH } {
	# Procedure called to update INTERNAL_STATE_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INTERNAL_STATE_WIDTH { PARAM_VALUE.INTERNAL_STATE_WIDTH } {
	# Procedure called to validate INTERNAL_STATE_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.INTERNAL_STATE_WIDTH { MODELPARAM_VALUE.INTERNAL_STATE_WIDTH PARAM_VALUE.INTERNAL_STATE_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INTERNAL_STATE_WIDTH}] ${MODELPARAM_VALUE.INTERNAL_STATE_WIDTH}
}
