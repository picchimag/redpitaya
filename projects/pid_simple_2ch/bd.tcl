...
# module references:
# integrator, pid_simple_axi_wrap, axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, pid_simple_axi_wrap
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins pid1/S_AXI1] [get_bd_intf_pins soc/M01_AXI]
  ...
  connect_bd_intf_net -intf_net soc_M00_AXI [get_bd_intf_pins soc/M00_AXI] [get_bd_intf_pins pid/S_AXI1]
  ...
  connect_bd_net -net iir2nd_y_out [get_bd_pins pid/y_out] [get_bd_pins dac/In0]
  connect_bd_net -net pid1_y_out [get_bd_pins pid1/y_out] [get_bd_pins dac/In1]
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins pid/s_axi_aclk] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins pid1/s_axi_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins pid/s_axi_aresetn] [get_bd_pins pid1/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins pid/x_in]
  connect_bd_net -net x_in_2 [get_bd_pins adc/Dout1] [get_bd_pins pid1/x_in]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs pid/pid_simple_axi_wrap_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40001000 -range 0x00001000 -with_name SEG_pid_simple_axi_wrap_0_reg0_1 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs pid1/pid_simple_axi_wrap_0/s_axi/reg0] -force
