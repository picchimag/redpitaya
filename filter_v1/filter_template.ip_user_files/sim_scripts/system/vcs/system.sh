...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xlconstant_v1_1_9 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0_clk_wiz.v" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../template1.gen/sources_1/bd/system/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xlconstant_v1_1_9 $vlogan_opts +v2k +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/3242" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../template1.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
