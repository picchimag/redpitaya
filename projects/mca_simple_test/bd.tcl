...
# module references:
# axis_red_pitaya_dac, axis_red_pitaya_adc, integrator, fir9_minimal_axi_wrap, iir1st_minimal_axi_wrap, peak_detector_axi_wrap, peak_height_binning_axi_wrap, signed_bitshift
...
proc create_hier_cell_MCA1 { parentCell nameHier } {
  ...
  connect_bd_net -net fir9_minimal_axi_wrap_0_y_out [get_bd_pins fir9_minimal_axi_wrap_0/y_out] [get_bd_pins peak_detector_axi_wr_0/x_in] [get_bd_pins signed_bitshift_0/din]
  ...
  connect_bd_net -net integrator_0_counter_clk [get_bd_pins integrator_0/counter_clk] [get_bd_pins fir9_minimal_axi_wrap_0/slow_clk] [get_bd_pins iir1st_minimal_axi_0/slow_clk] [get_bd_pins peak_detector_axi_wr_0/slow_clk] [get_bd_pins peak_height_binning_0/slow_clk]
  connect_bd_net -net integrator_0_x_out [get_bd_pins integrator_0/x_out] [get_bd_pins iir1st_minimal_axi_0/x_in]
  connect_bd_net -net peak_detector_axi_wr_0_peak_detected [get_bd_pins peak_detector_axi_wr_0/peak_detected_out] [get_bd_pins peak_height_binning_0/peak_detected]
  connect_bd_net -net peak_detector_axi_wr_0_peak_value_out [get_bd_pins peak_detector_axi_wr_0/peak_value_out] [get_bd_pins peak_height_binning_0/peak_value_in]
  connect_bd_net -net peak_height_binning_0_band_detected [get_bd_pins peak_height_binning_0/band_detected] [get_bd_pins y_out]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins integrator_0/clk] [get_bd_pins fir9_minimal_axi_wrap_0/s_axi_aclk] [get_bd_pins iir1st_minimal_axi_0/s_axi_aclk] [get_bd_pins peak_detector_axi_wr_0/s_axi_aclk] [get_bd_pins peak_height_binning_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins fir9_minimal_axi_wrap_0/s_axi_aresetn] [get_bd_pins iir1st_minimal_axi_0/s_axi_aresetn] [get_bd_pins peak_detector_axi_wr_0/s_axi_aresetn] [get_bd_pins peak_height_binning_0/s_axi_aresetn]
...
\
  ...
  set_property CONFIG.NUM_MI {20} $axi_interconnect_0
  ...
  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_1 [get_bd_pins M_AXI_GP0_ACLK] [get_bd_pins ps_0/M_AXI_GP0_ACLK] [get_bd_pins rst_0/slowest_sync_clk] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/M11_ACLK] [get_bd_pins axi_interconnect_0/M12_ACLK] [get_bd_pins axi_interconnect_0/M13_ACLK] [get_bd_pins axi_interconnect_0/M14_ACLK] [get_bd_pins axi_interconnect_0/M15_ACLK] [get_bd_pins axi_interconnect_0/M16_ACLK] [get_bd_pins axi_interconnect_0/M17_ACLK] [get_bd_pins axi_interconnect_0/M18_ACLK] [get_bd_pins axi_interconnect_0/M19_ACLK]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pll_0_clk_out1_125 [get_bd_pins pll_0/clk_out1] [get_bd_pins soc/M_AXI_GP0_ACLK] [get_bd_pins dac/aclk] [get_bd_pins adc/aclk] [get_bd_pins MCA1/s_axi_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins soc/peripheral_aresetn] [get_bd_pins MCA1/s_axi_aresetn]
  connect_bd_net -net x_in_1 [get_bd_pins adc/Dout0] [get_bd_pins MCA1/x_in]

  # Create address segments
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs MCA1/fir9_minimal_axi_wrap_0/s_axi/reg0] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -with_name SEG_iir1st_minimal_axi_w_0_reg0 -target_address_space [get_bd_addr_spaces soc/ps_0/Data] [get_bd_addr_segs MCA1/iir1st_minimal_axi_0/s_axi/reg0] -force
